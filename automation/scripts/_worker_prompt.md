...
1. 长期经济模型：公司能否持续产生自由现金流？增长是否依赖高资本开支、补贴、融资或会计利润，还是能转化为管理层可自由支配的现金。
...
3. 情景估值：悲观、基准、乐观三种情景，并说明各情景的关键假设、概率倾向、上行/下行赔率和永久资本损失风险。

估值结论必须包含“市场隐含预期”和“多因素估值中心倾向”。如果无法建立可信的自由现金流路径，必须降低结论置信度。
